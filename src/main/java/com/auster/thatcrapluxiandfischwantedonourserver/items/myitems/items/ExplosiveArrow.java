...
public class ExplosiveArrow extends MyItem {
    public static List<UUID> arrows = new ArrayList<>();

    public ExplosiveArrow() {
        modelid = 1234456;
        name = "Explosive Arrow";
        material = Material.SPECTRAL_ARROW;
        itemStackName = ChatColor.RED + "Explosive Arrow";
        lore = Arrays.asList(ChatColor.RED + "An Arrow that Explodes", ChatColor.RED + "What the Hell were you expecting?");
        enchanted = true;
        canBreakBlocks = true;
